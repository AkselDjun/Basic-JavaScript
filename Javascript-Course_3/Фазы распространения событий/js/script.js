...
//Суть распространения в том, что есть вложеные элементы и на дочерний элемент вызвать событие, то то же событие будет распространяться
// на все родительские элементы этого дочернего элемента. 
